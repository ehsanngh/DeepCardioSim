...
dltrain, dltest, data_processor = load_dataset_for_gino(
    ...
    train_batch_sizes=[15], test_batch_sizes=[15, 15],
    use_distributed=use_distributed, dataset_format=BipartiteData)
...
trainer.train(train_loader=dltrain[0],
              ...
              resume_from_dir="./cardiac_examples/electrophysio/GINO/ckpt")

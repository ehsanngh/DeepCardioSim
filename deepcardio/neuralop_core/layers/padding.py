# Source: https://github.com/neuraloperator/neuraloperator/blob/main/neuralop/layers/padding.py
...
from deepcardio.neuralop_core.utils import validate_scaling_factor
